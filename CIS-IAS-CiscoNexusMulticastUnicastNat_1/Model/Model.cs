namespace Skyline.Automation.CiscoNexusMulticastUnicastNat.Model
{
    using System;
    ...
    public class Model
    {
        ...
        internal void PushConfigs(View view)
        {
            ...
            stringBuilder.Append($"ip service-reflect destination {view.SourceMulticastIpAddress.Text} to {view.DestinationUnicastIpAddress1.Text} mask-len 32 source {view.SourceUnicastIpAddress.Text} to {view.DestinationUnicastIpAddress2.Text} mask-len 32;");
        ...
        internal void RemoveConfigs(View view)
        {
            ...
            stringBuilder.Append($"no ip service-reflect destination {view.SourceMulticastIpAddress.Text} to {view.DestinationUnicastIpAddress1.Text} mask-len 32 source {view.SourceUnicastIpAddress.Text} to {view.DestinationUnicastIpAddress2.Text} mask-len 32;");
