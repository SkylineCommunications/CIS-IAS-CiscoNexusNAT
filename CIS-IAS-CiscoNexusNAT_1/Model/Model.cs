namespace Skyline.Automation.CiscoNexusNat.Model
{
    using System;
    ...
    public class Model
    {
        ...
        internal void PushConfigs(View view)
        {
            ...
            var sourceMulticastNetworkAddress = GetNetworkAddress(view.SourceMulticastIpAddress.Text, "24");
            ...
            stringBuilder.Append($"ip igmp static-oif {view.SourceMulticastIpAddress.Text}");
            ...
            stringBuilder.Append($"ip service-reflect mode egress {sourceMulticastNetworkAddress};");
            stringBuilder.Append($"ip service-reflect destination {view.SourceMulticastIpAddress.Text} to {view.DestinationMulticastIpAddress.Text} mask-len 32 source {view.SourceIpAddress.Text} to {view.DestinationIpAddress.Text} mask-len 32 static-oif {view.SourcePhysicalInterface.Selected};");
            stringBuilder.Append($"multicast service-reflect interface all map interface {view.DestinationPhysicalInterface.Selected} max-replication 3");
        ...
        internal void RemoveConfigs(View view)
        {
            ...
            stringBuilder.Append($"no multicast service-reflect interface all map interface {view.DestinationPhysicalInterface.Selected} max-replication 3;");
            stringBuilder.Append($"no ip service-reflect destination {view.SourceMulticastIpAddress.Text} to {view.DestinationMulticastIpAddress.Text} mask-len 32 source {view.SourceIpAddress.Text} to {view.DestinationIpAddress.Text} mask-len 32 static-oif {view.SourcePhysicalInterface.Selected};");
            stringBuilder.Append($"no ip service-reflect mode egress {sourceMulticastNetworkAddress};");
